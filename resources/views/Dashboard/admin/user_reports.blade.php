...
<div class="user-reports-page">
        ...
        <div class="col-md-12">
            <form action="">
                <div class="select-box">
                    <label for="yearSelect">Reports Of The Year:</label>
    ...
    <select id="tenantSelect">
        <option value="" disabled selected>Robert Strom</option>
        ...
        <option value="maria-garcia">Maria Garcia</option>
            ...
            <div class="reports-three-boxes">
                <div class="user-reports-yealt">
                    <div class="report-item">Rent</div>
                    <div class="report-item">12 January 2024</div>
                    <div class="report-item paid">Paid</div>
                  </div>
                  <div class="user-reports-yealt">
                    <div class="report-item">Sign Up</div>
                    <div class="report-item">12 February 2024</div>
                    <div class="report-item paid">Paid</div>
                  </div>
                  <div class="user-reports-yealt">
                    <div class="report-item">Credit Report</div>
                    <div class="report-item">12 March 2024</div>
                    <div class="report-item paid">Paid</div>
                  </div>
            </div>

...
<style>
    .dashboard-main .left-panel .left-panel-menu ul li a.rent-to-who {
        background-color: white;
        color: #414141;
    }

    .dashboard-main .left-panel .left-panel-menu ul li a.rent-to-who svg path {
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="profile-basic-info-form">
                ...
                <h3>Rent To Who Edit</h3>
                @if (Auth::user()->hasRole('admin'))
                    <form
                        action="{{ route('admin.rent-to-who.update' , $rentToWho->id) }}"
                        method="POST">
                        @csrf
